...
import NetSaleDiwaliBar from "./CurrentDiwaliYear/NetSaleDiwaliBar";
import NetSaleDiwaliLine from "./CurrentDiwaliYear/NetSaleDiwaliLine";
import CurrentDiwaliYearTable from "./CurrentDiwaliYear/CurrentDiwaliYearTable";

export default function CurrentDiwaliYear({ VendorWiseData }: any) {
  ...
  return (
    <div>
      <div className="bg-white items-center shadow-sm rounded my-4 border border-[#E0E0FF]">
        ...
        >
          ...
          <div className="col-span-12 ">
            ...
            {displayOption === DisplayOptions.GRAPH && (
              <div className="px-4 ">
                <NetSaleDiwaliBar VendorWiseData={VendorWiseData} />
              </div>
            )}
            {displayOption === DisplayOptions.TABLE && (
              <div className="px-4">
                <NetSaleDiwaliLine VendorWiseData={VendorWiseData} />
              </div>
            )}
          </div>
      ...
      {/* <div className="bg-white items-center shadow-sm rounded my-4 border border-[#E0E0FF]">
        ...
        <div className="p-4">
          <CurrentDiwaliYearTable VendorWiseData={VendorWiseData} />
        </div>
      </div> */}
    </div>
  );
