...
import NetSaleTrendBar from "./CurrrrentMonth/NetSaleTrendBar";
import NetSaleTrendLine from "./CurrrrentMonth/NetSaleTrendLine";
      ...
      <div className="bg-white items-center shadow-sm rounded my-4 border border-[#E0E0FF]">
        ...
        >
          ...
          <div className="col-span-12 ">
            ...
            {displayOption === DisplayOptions.GRAPH && (
              <div className="px-4 ">
                <NetSaleTrendBar VendorWiseData={VendorWiseData} />
              </div>
            )}
            {displayOption === DisplayOptions.TABLE && (
              <div className="px-4">
                <NetSaleTrendLine VendorWiseData={VendorWiseData} />
              </div>
            )}
          </div>
