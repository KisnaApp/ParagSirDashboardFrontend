...
export const TopNav = () => {
  ...
  return (
    <Box
      role="menu"
      className="shadow-md text-white bg-vrBlack  w-full py-3 px-2  flex flex-row items-center justify-between"
    >
      <Logo />
          ...
          {({ isOpen }) => (
            <>
              ...
              <MenuList color="black" bg="white" fontSize="12px">
                ...
                <MenuDivider /> */}
                <MenuItem icon={<TbLogout2 fontSize="12px" />}>Logout</MenuItem>
              </MenuList>
            </>
          )}
        </Menu>
